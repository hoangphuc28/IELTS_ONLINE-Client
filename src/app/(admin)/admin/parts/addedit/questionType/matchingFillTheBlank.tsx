...
import { Answer, Dropdown, MultipleResponse, MatchingFillBlank } from '../../type/Question';
import {
    Accordion,
    AccordionActions,
    AccordionDetails,
...
export default function MatchingFillBlankForm(props: QuestionProps) {
    const DynamicEditor = dynamic(() => import('../_components/editor/editor'), { ssr: false })
    const Editor = useMemo(() => DynamicEditor, [])
    const [question, setQuestion] = useState<MatchingFillBlank>(props.data as MatchingFillBlank)
    return (
        <Fragment>
