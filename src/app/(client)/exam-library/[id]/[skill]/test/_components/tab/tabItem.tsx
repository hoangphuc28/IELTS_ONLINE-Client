...
export default function ComponentTabItem({
    ...
    // let itemName = 'Part'
    // if (params.skill.toLowerCase() === testSkill.WRITING.toLowerCase()) itemName = 'Task'
    ...
    return (
        <>
            ...
            >
                ...
                <div
                    className={
                        'rounded-lg border border-violet-100 px-1 items-center gap-1 ' +
                        `${index === 0 ? 'flex' : 'hidden'}`
                    }
                        ...
                        <>
                            ...
                            {questions.map((question, index) => (
                                <button
                                    ...
                                    className="border w-8 h-8 rounded-full bg-violet-100 hover:opacity-[0.7] hover:shadow-lg"
